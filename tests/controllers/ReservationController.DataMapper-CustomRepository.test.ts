...
const url = '/v1/data-mapper/custom-repository/reservation'

describe('reservation - Data Mapper Pattern (Custom Repository)', () => {
  beforeEach(async () => {
  ...
  it('update', async () => {
    await createReservation()
    const update = { returnDate: '2000-01-01T02:00:00.000Z' }
    const app = await App.startServer()
